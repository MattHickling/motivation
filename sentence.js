let sentences = [
    "Its not the size of the dog in the fight, but the size of the fight in the dog.-Archie Griffen", 
    ...
    "quit being afraid when my first venture failed and the sky didn't fall down. -Allen H Neuharth",
...
function randomSentence(){
    let index = Math.floor(Math.random() * (totalSentences - 1));
    alert(sentences[index]) 
}
